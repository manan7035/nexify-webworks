...
import { ArrowUpRight, Zap, Code2, Layout, Gauge, Star, CheckCircle2, ShieldCheck, Sparkles, Activity, Layers, ArrowRight, Quote, Search, BarChart3, Check } from 'lucide-react';

interface HomeViewProps {
  onNavigate: (page: NavigationPage) => void;
  onSelectProject: (project: Project) => void;
  onLaunchCalculation?: (summary: {
    platform: string;
    features: string[];
...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="space-y-0">
      ...
      <ShowcaseSection onSelectProject={onSelectProject} onNavigate={onNavigate} />
